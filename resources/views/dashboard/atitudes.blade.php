        ...
        <div class="row">
          <table class="table table-responsive-sm table-hover table-outline mb-0">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td class="text-center">
                              <svg class="c-icon c-icon-xl">
                                <use xlink:href="{{ url('assets/icons/brands/brands-symbol-defs.svg#cc-mastercard') }}"></use>
                              </svg>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ url('assets/img/avatars/2.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-danger"></span></div>
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                              <svg class="c-icon c-icon-xl">
                                <use xlink:href="{{ url('assets/icons/brands/brands-symbol-defs.svg#cc-visa') }}"></use>
                              </svg>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ url('assets/img/avatars/3.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-warning"></span></div>
                            </td>
                            <td>
                              <div>Quintin Ed</div>
                              <div class="small text-muted"><span>New</span> | Registered: Jan 1, 2015</div>
                            ...
                            <td class="text-center">
                              <svg class="c-icon c-icon-xl">
                                <use xlink:href="{{ url('assets/icons/brands/brands-symbol-defs.svg#cc-stripe') }}"></use>
                              </svg>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ url('assets/img/avatars/4.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-secondary"></span></div>
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                              <svg class="c-icon c-icon-xl">
                                <use xlink:href="{{ url('assets/icons/brands/brands-symbol-defs.svg#cc-paypal') }}"></use>
                              </svg>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ url('assets/img/avatars/5.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-success"></span></div>
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                              <svg class="c-icon c-icon-xl">
                                <use xlink:href="{{ url('assets/icons/brands/brands-symbol-defs.svg#cc-apple-pay') }}"></use>
                              </svg>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ url('assets/img/avatars/6.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-danger"></span></div>
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                              <svg class="c-icon c-icon-xl">
                                <use xlink:href="{{ url('assets/icons/brands/brands-symbol-defs.svg#cc-amex') }}"></use>
                              </svg>
                            </td>
                            <td>
